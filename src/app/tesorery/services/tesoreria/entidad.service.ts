...
export class EntidadService {
  ...
  registerTipoEntidad(datos: any) {
    return this.apiService.tesoreria.post(
      `${this.apiUrl}${this.prefix}/${this.apiName}/${datos.entidadId}/tipoEntidad`,
      datos
    );
  }
  ...
  getEntidadesTipoEntidad(entidadId: any) {
    return this.apiService.tesoreria.get(
      `${this.apiUrl}${this.prefix}/${this.apiName}/entidadReferencial/tipoEntidad/${entidadId}`
    );
  }
  getTipoEntidad() {
  ...
  deleteEntidadTipo(data: any) {
    return this.apiService.tesoreria.delete(
      `${this.apiUrl}${this.prefix}/${this.apiName}/${data.entidadId}/tipoEntidad/${data.tipoEntidadId}`
    );
  }
  listaEntidadReferncial() {
    return this.apiService.tesoreria.get(
      `${this.apiUrl}${this.prefix}/${this.apiName}/entidadReferencial`
    );
  }
  listaEntidadReferencialTipoEntidad(id: string | number = "") {
    return this.apiService.tesoreria.get(
  ...
  getEntidadesByTipo(tipoEntidad: String) {
    return this.apiService.tesoreria.get(
      `${this.apiUrl}${this.prefix}/${this.apiName}/entidadReferencial/${tipoEntidad}/tipoEntidad`
    );
  }
}
