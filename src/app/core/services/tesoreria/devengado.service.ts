...
export class DevengadoService {
	constructor(private apiService: ConsumoApiService) {}
  apiName: string = 'devengado'
	apiUrl: string = ''
	prefix: string = ''
  ...
  detalleDevengado(devengadoId){
    return this.apiService.tesoreria.get(`${this.apiUrl}${this.prefix}/${this.apiName}/${devengadoId}`);
  }
}
