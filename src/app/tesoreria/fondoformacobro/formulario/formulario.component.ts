...
this.FormacobroService.getAll(100, 1, 'nombre', false, '').subscribe((res:any) => { this.forma_cobro = res.content; });
  ...
  ngOnInit(): void {    
    this.cargarArrays();
    this.formGroup = this.FormBuilder.group({id:["",[] ],fondoId:["",[Validators.required] ],formaCobroId:["",[Validators.required] ]});
    if (this.dataEdit != null) {
      this.formGroup.setValue({id:this.dataEdit.id,fondoId:this.dataEdit.fondoId,formaCobroId:this.dataEdit.formaCobroId});
      this.rel_prefix = "/fondo_forma_cobro/"+this.dataEdit.id;
    }
    ...
    if (id != null && !this.esModal && id!="nuevo" ) {
      this.FondoformacobroService.find(id).subscribe((result:any) => {
        ...
        if (Array.isArray(result.content))
          ...
          this.formGroup.setValue({id:this.dataEdit.id,fondoId:this.dataEdit.fondoId,formaCobroId:this.dataEdit.formaCobroId});
          this.rel_prefix = "/fondo_forma_cobro/"+id;
          this.rel_id = id;
      });
    }
  }
