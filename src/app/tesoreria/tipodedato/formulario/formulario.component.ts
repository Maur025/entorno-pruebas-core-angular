...
@Component({
  selector: "app-formulario-tipodedato",
...
export class FormularioComponent implements OnInit {
  ...
  constructor(
    ...
    private TipodedatoService: TipodedatoService,
  ...
  guardar() {
    ...
    if (this.formGroup.valid) {
      ...
      if (this.dataEdit == null) {
        this.TipodedatoService.register(sendData).subscribe(
          (res: any) => {
        ...
        this.TipodedatoService.update(sendData, this.dataEdit.id).subscribe(
          (res: any) => {
            this.notificacionService.successStandar();
