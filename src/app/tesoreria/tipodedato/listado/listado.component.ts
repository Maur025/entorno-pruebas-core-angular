...
import { TipodedatoService } from "../servicios/tipodedato.service";
...
@Component({
  selector: "app-listado-tipodedato",
...
export class ListadoComponent implements OnInit {
  ...
  formato: any;
  dataEdit = null;
  titulo: any = "Listado de Tipodedato";

  

  constructor(
    public TipodedatoService: TipodedatoService,
  ...
  ngOnInit(): void {
    if (this.rel_prefix) this.TipodedatoService.setPrefix(this.rel_prefix);
    this.formato = {
  ...
  habilitar(data: any, component) {
    this.TipodedatoService.habilitar(data, data.id).subscribe(
      (data) => {
  ...
  deshabilitar(data: any, component) {
    this.TipodedatoService.deshabilitar(data, data.id).subscribe(
      (data) => {
        component.obtenerDatos();
        this.NotificacionService.successStandar(
  ...
  eliminar(data: any, component) {
    this.NotificacionService.alertaEliminacion(data.nombre, (response: any) => {
      if (response) {
        this.TipodedatoService.delete(data.id).subscribe(
          (data) => {
            component.obtenerDatos();
            this.NotificacionService.successStandar(
