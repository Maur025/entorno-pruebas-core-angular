...
export class FormularioComponent implements OnInit {
  ...
  ngOnInit(): void {    
    this.cargarArrays();
    this.formGroup = this.FormBuilder.group({id:["",[Validators.required] ],nombre:["",[Validators.required,Validators.minLength(2),Validators.maxLength(255)] ],nombrecompleto:["",[Validators.required,Validators.minLength(2),Validators.maxLength(255)] ],cargo:["",[Validators.minLength(0),Validators.maxLength(255)] ],uid:["",[] ]});
