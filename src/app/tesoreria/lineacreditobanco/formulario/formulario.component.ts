...
@Component({
  selector: "app-formulario-lineacreditobanco",
...
banco:any = [];
  ...
  constructor(
    ...
    private LineacreditoService: LineacreditoService,private BancoService: BancoService
  ) {}
  ...
  guardar() {
    ...
    if (this.formGroup.valid) {
      ...
      if (this.dataEdit == null) {
        ...
        this.LineacreditobancoService.update(sendData, this.dataEdit.id).subscribe(
          (res: any) => {
            this.notificacionService.successStandar();
