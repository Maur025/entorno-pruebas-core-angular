...
@Component({
  selector: "app-formulario-tipopago",
...
export class FormularioComponent implements OnInit {
  ...
  ngOnInit(): void {    
    ...
    if (this.dataEdit != null) {
      ...
      this.rel_prefix = "/tipopago/"+this.dataEdit.id;
    }
  ...
  guardar() {
    ...
    if (this.formGroup.valid) {
      ...
      if (this.dataEdit == null) {
        ...
        this.TipopagoService.update(sendData, this.dataEdit.id).subscribe(
          (res: any) => {
            this.notificacionService.successStandar();
