...
@Component({
  selector: "app-listado-entidadestipoentidad",
...
export class ListadoComponent implements OnInit {
  ...
  formato: any;
  dataEdit = null;
  titulo: any = "Tipo Entidad- Entidad";
...
entidades:any = [];
  ...
  habilitar(data: any, component) {
    this.EntidadestipoentidadService.habilitar(data, data.id).subscribe(
      (data) => {
  ...
  deshabilitar(data: any, component) {
    this.EntidadestipoentidadService.deshabilitar(data, data.id).subscribe(
      (data) => {
        component.obtenerDatos();
        this.NotificacionService.successStandar(
  ...
  eliminar(data: any, component) {
    this.NotificacionService.alertaEliminacion(data.nombre, (response: any) => {
      if (response) {
        this.EntidadestipoentidadService.delete(data.id).subscribe(
          (data) => {
            component.obtenerDatos();
            this.NotificacionService.successStandar(
