...
@Component({
  selector: "app-formulario-tiempointeres",
...
export class FormularioComponent implements OnInit {
  ...
  ngOnInit(): void {    
    ...
    this.formGroup = this.FormBuilder.group({id:["",[] ],nombre:["",[Validators.required,Validators.minLength(2),Validators.maxLength(255)] ],descripcion:["",[Validators.maxLength(255)] ],dias:["",[Validators.required] ]});
  ...
  guardar() {
    ...
    if (this.formGroup.valid) {
      ...
      if (this.dataEdit == null) {
        this.TiempointeresService.register(sendData).subscribe(
          (res: any) => {
        ...
        this.TiempointeresService.update(sendData, this.dataEdit.id).subscribe(
          (res: any) => {
            this.notificacionService.successStandar();
