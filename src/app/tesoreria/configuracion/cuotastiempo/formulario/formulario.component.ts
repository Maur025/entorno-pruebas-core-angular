...
export class FormularioComponent implements OnInit {
  ...
  ngOnInit(): void {    
    ...
    this.formGroup = this.FormBuilder.group({id:["",[] ],nombre:["",[Validators.required,Validators.minLength(2),Validators.maxLength(100)] ],descripcion:["",[Validators.maxLength(255)] ],dias:["",[Validators.required,Validators.min(0)] ]});
