...
export class FormularioComponent implements OnInit {
  ...
  ngOnInit(): void {    
    this.cargarArrays();
    this.formGroup = this.FormBuilder.group({id:["",[] ],nombre:["",[Validators.required,Validators.minLength(2),Validators.maxLength(255)] ],descripcion:["",[Validators.maxLength(255)] ],estado:["",[Validators.maxLength(255)] ]});
    if (this.dataEdit != null) {
      ...
      this.rel_prefix = "/forma_cobro/"+this.dataEdit.id;
    }
    ...
    if (id != null && !this.esModal && id!="nuevo" ) {
      this.FormacobroService.find(id).subscribe((result:any) => {
        ...
        if (Array.isArray(result.content))
          ...
          this.formGroup.setValue({id:this.dataEdit.id,nombre:this.dataEdit.nombre,descripcion:this.dataEdit.descripcion,estado:this.dataEdit.estado});
          this.rel_prefix = "/forma_cobro/"+id;
          this.rel_id = id;
      });
    }
  }
