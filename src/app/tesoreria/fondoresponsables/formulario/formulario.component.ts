...
this.FondoService.getAll(100, 1, 'nombre', false, '').subscribe((res:any) => { this.fondo = res.content; });
  ...
  ngOnInit(): void {    
    this.cargarArrays();
    this.formGroup = this.FormBuilder.group({id:["",[] ],responsableId:["",[] ],fondoId:["",[] ],estado:["",[] ]});
    if (this.dataEdit != null) {
      this.formGroup.setValue({id:this.dataEdit.id,responsableId:this.dataEdit.responsableId,fondoId:this.dataEdit.fondoId,estado:this.dataEdit.estado});
      this.rel_prefix = "/fondo_responsables/"+this.dataEdit.id;
    }
    ...
    if (id != null && !this.esModal && id!="nuevo" ) {
      this.FondoresponsablesService.find(id).subscribe((result:any) => {
        ...
        if (Array.isArray(result.content))
          ...
          this.formGroup.setValue({id:this.dataEdit.id,responsableId:this.dataEdit.responsableId,fondoId:this.dataEdit.fondoId,estado:this.dataEdit.estado});
          this.rel_prefix = "/fondo_responsables/"+id;
          this.rel_id = id;
      });
    }
  }
