...
export class ListaComponent  extends FuncionesComponent implements OnInit{
  ...
  get form() {return this.formBancoCreate.controls}
  ...
  confirmAndContinueSaving = async (): Promise<void> => {
		this.submitted = true;
		if (!this.formBancoCreate.valid) {return}
  ...
  registrar(){
    if(this.idBancoEdit){
      this.bancoService.update(this.formBancoCreate.value).subscribe(data=>{
        this.cerrarModal();
        this.notificacionService.successStandar();
        this.tabla.obtenerDatos();
      }, error=>this.notificacionService.alertError(error));
    }else{
      this.bancoService.register(this.formBancoCreate.value).subscribe(data=>{
        this.cerrarModal();
        this.notificacionService.successStandar();
        this.tabla.obtenerDatos();
      }, error=>this.notificacionService.alertError(error));
